...
nnoremap <silent> <leader>ei3 :edit ~/config/installation/install3.fish<CR>
nnoremap <silent> <leader>esc :edit ~/config/shell/commands.fish<CR>
nnoremap <silent> <leader>ese :edit ~/config/shell/env.fish<CR>
